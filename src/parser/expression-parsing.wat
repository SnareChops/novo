...
(module $novo_parser_expression_parsing
  ...
  (import "ast_expression_creators" "create_expr_add" (func $create_expr_add (param i32 i32) (result i32)))
  (import "ast_expression_creators" "create_expr_sub" (func $create_expr_sub (param i32 i32) (result i32)))
  (import "ast_expression_creators" "create_expr_mul" (func $create_expr_mul (param i32 i32) (result i32)))
  (import "ast_expression_creators" "create_expr_div" (func $create_expr_div (param i32 i32) (result i32)))
  (import "ast_expression_creators" "create_expr_mod" (func $create_expr_mod (param i32 i32) (result i32)))
