...
(module $ast_node_creators_test
  ...
  (import "ast_node_creators" "create_expr_string_literal" (func $create_expr_string_literal (param i32) (param i32) (result i32)))
  (import "ast_node_creators" "create_expr_add" (func $create_expr_add (param i32) (param i32) (result i32)))
  (import "ast_node_creators" "create_expr_sub" (func $create_expr_sub (param i32) (param i32) (result i32)))
  (import "ast_node_creators" "create_expr_mul" (func $create_expr_mul (param i32) (param i32) (result i32)))
  (import "ast_node_creators" "create_expr_div" (func $create_expr_div (param i32) (param i32) (result i32)))
  (import "ast_node_creators" "create_expr_mod" (func $create_expr_mod (param i32) (param i32) (result i32)))
  ...
  (import "ast_node_creators" "create_type_result" (func $create_type_result (param i32) (param i32) (result i32)))
